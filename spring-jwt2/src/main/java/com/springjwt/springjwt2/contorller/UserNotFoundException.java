...
public class UserNotFoundException {
    ...
    @ExceptionHandler
    public ResponseEntity<UserResponseError> ProductError(NotFoundVerification exception){
    ...
    @ExceptionHandler
    public ResponseEntity<UserResponseError> ProductError(NotFoundEmailException exception){
    ...
    @ExceptionHandler
    public ResponseEntity<UserResponseError> ProductError(TypeNotMatchException exception){
